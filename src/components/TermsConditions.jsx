        ...
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          >
            <div className="p-6 sm:p-8 md:p-10">
              <h1 className="text-3xl md:text-4xl font-bold text-gray-800 mb-8 text-center">Terms & Conditions</h1>
              ...
              <section className="mb-8 space-y-4 text-gray-700 leading-relaxed">
                ...
                <p>
                  ...
                  <a href="https://shwetanshwelfaretrust.vercel.app/" className="text-blue-600 hover:underline">
                    https://shwetanshwelfaretrust.vercel.app/
                  </a> ('Website'), including the related mobile site and mobile application (hereinafter referred to as 'Platform').
                </p>
                <p>
                  The Platform is owned by <strong>Shwetansh Welfare and Educational Trust</strong>, a company incorporated under the Companies Act, 1956 with its registered office at DEEPSHIKA BHAWAN, CIVIL LINES, Shahdol, India (hereinafter referred to as 'Platform Owner', 'we', 'us', 'our').
                </p>
                <p>
              ...
              <section className="mb-8 space-y-4 text-gray-700 leading-relaxed">
                ...
                <p className="font-semibold text-gray-800 p-4 bg-amber-50 border-l-4 border-amber-400 rounded-md">
                ...
                <ol className="list-decimal pl-6 space-y-3">
                  ...
                  <li>All disputes arising out of or in connection with these Terms shall be subject to the exclusive jurisdiction of the courts in Shahdol and Madhya Pradesh.</li>
